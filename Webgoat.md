...
8. 破坏完整性（添加新的语句）
```
SELECT * FROM employees WHERE last_name = ‘Smith' AND auth_tan ='3SL99A';UPDATEor '1'='1';
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE2ODE1ODQ3OCwxODY5MTA3OTYxLC0xMj
...
MCwtNTY0MTQwMDg0LC0xMTA2NzUyNDkwLDIzOTQzNzQwNCwtNT
QyMDg5MjQzLC00MjE5Mjg3ODYsLTE1NzQyNzU5MTAsLTEwNTQ0
ODc5MzZdfQ==
-->