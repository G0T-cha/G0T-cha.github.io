...
8. 破坏完整性（添加新的语句）
```
SELECT * FROM employees WHERE last_name = ‘Smith' AND auth_tan ='3SL99A';UPDATE employees  SET salary=;
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI0NDMzMTIxNiwtMTk2NzM4OTQzNCwxOD
...
ODAxLDQ1MDA4OTIwMCwtNTY0MTQwMDg0LC0xMTA2NzUyNDkwLD
IzOTQzNzQwNCwtNTQyMDg5MjQzLC00MjE5Mjg3ODYsLTE1NzQy
NzU5MTBdfQ==
-->