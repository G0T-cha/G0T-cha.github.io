...
~~使用参数命令检测不出漏洞？~~
右键保存为RAW，使用命令：`sqlmap -r 桌面/1.raw`，可以检测出注册用户名存在m漏洞

<!--stackedit_data:
eyJoaXN0b3J5IjpbNTI3MDk4NTU3LC0yMDc2MTY1MTMzLDE2Mz
...
OTYyMTg0LC0xMzg2NDIzNDEsODU1MTg2NTAxLDEzNDIwMTcwMj
csMTk5MjkyNDMsLTUwMDk0NjgwMSw0NTAwODkyMDAsLTU2NDE0
MDA4NF19
-->